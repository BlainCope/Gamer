...
static_assert(sizeof(UDrawPortalComponent) == 0x000480, "Wrong size on UDrawPortalComponent");
...
static_assert(sizeof(UDrawRoomComponent) == 0x000480, "Wrong size on UDrawRoomComponent");
