...
static_assert(alignof(UM1NavModifierSmallerMaxZComponent) == 0x000010, "Wrong alignment on UM1NavModifierSmallerMaxZComponent");
static_assert(sizeof(UM1NavModifierSmallerMaxZComponent) == 0x000150, "Wrong size on UM1NavModifierSmallerMaxZComponent");
...
static_assert(alignof(AM1SkeletalMeshActor) == 0x000008, "Wrong alignment on AM1SkeletalMeshActor");
static_assert(sizeof(AM1SkeletalMeshActor) == 0x0002C8, "Wrong size on AM1SkeletalMeshActor");
...
static_assert(alignof(AM1WorldSettings) == 0x000008, "Wrong alignment on AM1WorldSettings");
static_assert(sizeof(AM1WorldSettings) == 0x000428, "Wrong size on AM1WorldSettings");
static_assert(offsetof(AM1WorldSettings, GravityScale) == 0x000420, "Member 'AM1WorldSettings::GravityScale' has a wrong offset!");
...
{
public:
	bool                                          bDisableAnimPhys;                                  // 0x0E50(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESkeletalMeshSignificanceLevel                Significance;                                      // 0x0E51(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_E52[0xE];                                      // 0x0E52(0x000E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UM1SkeletalMeshComponentBudgeted) == 0x000010, "Wrong alignment on UM1SkeletalMeshComponentBudgeted");
static_assert(sizeof(UM1SkeletalMeshComponentBudgeted) == 0x000E60, "Wrong size on UM1SkeletalMeshComponentBudgeted");
static_assert(offsetof(UM1SkeletalMeshComponentBudgeted, bDisableAnimPhys) == 0x000E50, "Member 'UM1SkeletalMeshComponentBudgeted::bDisableAnimPhys' has a wrong offset!");
static_assert(offsetof(UM1SkeletalMeshComponentBudgeted, Significance) == 0x000E51, "Member 'UM1SkeletalMeshComponentBudgeted::Significance' has a wrong offset!");
...
static_assert(alignof(UM1StaticMeshComponent) == 0x000010, "Wrong alignment on UM1StaticMeshComponent");
static_assert(sizeof(UM1StaticMeshComponent) == 0x000530, "Wrong size on UM1StaticMeshComponent");
...
static_assert(alignof(AM1StaticMeshActor) == 0x000008, "Wrong alignment on AM1StaticMeshActor");
static_assert(sizeof(AM1StaticMeshActor) == 0x000268, "Wrong size on AM1StaticMeshActor");
static_assert(offsetof(AM1StaticMeshActor, bMag_FillCollisionInsideForNavmesh) == 0x000258, "Member 'AM1StaticMeshActor::bMag_FillCollisionInsideForNavmesh' has a wrong offset!");
static_assert(offsetof(AM1StaticMeshActor, NavModifierComp) == 0x000260, "Member 'AM1StaticMeshActor::NavModifierComp' has a wrong offset!");
...
static_assert(alignof(UM1WindDirectionalSourceComponent) == 0x000010, "Wrong alignment on UM1WindDirectionalSourceComponent");
static_assert(sizeof(UM1WindDirectionalSourceComponent) == 0x000260, "Wrong size on UM1WindDirectionalSourceComponent");
static_assert(offsetof(UM1WindDirectionalSourceComponent, GustParameter) == 0x000210, "Member 'UM1WindDirectionalSourceComponent::GustParameter' has a wrong offset!");
static_assert(offsetof(UM1WindDirectionalSourceComponent, WindChannels) == 0x00022C, "Member 'UM1WindDirectionalSourceComponent::WindChannels' has a wrong offset!");
