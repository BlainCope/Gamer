...
static_assert(sizeof(UI_InvasionDungeon_Timer_C_ExecuteUbergraph_UI_InvasionDungeon_Timer) == 0x000004, "Wrong size on UI_InvasionDungeon_Timer_C_ExecuteUbergraph_UI_InvasionDungeon_Timer");
