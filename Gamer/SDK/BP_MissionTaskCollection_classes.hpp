...
static_assert(sizeof(ABP_MissionTaskCollection_C) == 0x000668, "Wrong size on ABP_MissionTaskCollection_C");
static_assert(offsetof(ABP_MissionTaskCollection_C, Billboard) == 0x000660, "Member 'ABP_MissionTaskCollection_C::Billboard' has a wrong offset!");
