...
public:
	...
	class UNiagaraComponent*                      InteractableAreaFx;                                // 0x0690(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_MissionTaskInteraction_C) == 0x0006A0, "Wrong size on ABP_MissionTaskInteraction_C");
static_assert(offsetof(ABP_MissionTaskInteraction_C, UberGraphFrame) == 0x000688, "Member 'ABP_MissionTaskInteraction_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_MissionTaskInteraction_C, InteractableAreaFx) == 0x000690, "Member 'ABP_MissionTaskInteraction_C::InteractableAreaFx' has a wrong offset!");
static_assert(offsetof(ABP_MissionTaskInteraction_C, Billboard) == 0x000698, "Member 'ABP_MissionTaskInteraction_C::Billboard' has a wrong offset!");
