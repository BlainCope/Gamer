...
public:
	...
	class AM1WireCaster*                          CallFunc_GetWireCaster_ReturnValue;                // 0x0880(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class USceneComponent*                        CallFunc_GetAttachParent_ReturnValue;              // 0x0888(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 CallFunc_GetOwnerActor_ReturnValue_3;              // 0x08A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AM1Player*                              K2Node_DynamicCast_AsM1Player;                     // 0x08A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(float DeltaSeconds)>           K2Node_CreateDelegate_OutputDelegate_15;           // 0x08B4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate_16;           // 0x08C4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_8D4[0x4];                                      // 0x08D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_UpdatePositionAndIK_DeltaSeconds_ImplicitCast; // 0x08D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_UpdateStamina_DeltaSeconds_ImplicitCast;  // 0x08E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone) == 0x0008E8, "Wrong size on Ability_Debone_C_ExecuteUbergraph_Ability_Debone");
...
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, CallFunc_GetWireCaster_ReturnValue) == 0x000880, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::CallFunc_GetWireCaster_ReturnValue' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, CallFunc_GetAttachParent_ReturnValue) == 0x000888, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::CallFunc_GetAttachParent_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, CallFunc_GetOwnerActor_ReturnValue_3) == 0x0008A0, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::CallFunc_GetOwnerActor_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, K2Node_DynamicCast_AsM1Player) == 0x0008A8, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::K2Node_DynamicCast_AsM1Player' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, K2Node_DynamicCast_bSuccess_5) == 0x0008B0, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::K2Node_DynamicCast_bSuccess_5' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, K2Node_CreateDelegate_OutputDelegate_15) == 0x0008B4, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::K2Node_CreateDelegate_OutputDelegate_15' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, K2Node_CreateDelegate_OutputDelegate_16) == 0x0008C4, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::K2Node_CreateDelegate_OutputDelegate_16' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, CallFunc_UpdatePositionAndIK_DeltaSeconds_ImplicitCast) == 0x0008D8, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::CallFunc_UpdatePositionAndIK_DeltaSeconds_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Ability_Debone_C_ExecuteUbergraph_Ability_Debone, CallFunc_UpdateStamina_DeltaSeconds_ImplicitCast) == 0x0008E0, "Member 'Ability_Debone_C_ExecuteUbergraph_Ability_Debone::CallFunc_UpdateStamina_DeltaSeconds_ImplicitCast' has a wrong offset!");
