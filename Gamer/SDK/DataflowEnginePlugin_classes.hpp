...
{
public:
	uint8                                         Pad_478[0x128];                                    // 0x0478(0x0128)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDataflowComponent) == 0x0005A0, "Wrong size on UDataflowComponent");
