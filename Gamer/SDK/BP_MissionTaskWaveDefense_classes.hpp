...
static_assert(sizeof(ABP_MissionTaskWaveDefense_C) == 0x000730, "Wrong size on ABP_MissionTaskWaveDefense_C");
static_assert(offsetof(ABP_MissionTaskWaveDefense_C, Billboard) == 0x000728, "Member 'ABP_MissionTaskWaveDefense_C::Billboard' has a wrong offset!");
