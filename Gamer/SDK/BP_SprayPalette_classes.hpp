...
public:
	...
	class USceneComponent*                        Scene;                                             // 0x0258(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UAkAudioEvent*                          AkAudio;                                           // 0x0260(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_SprayPalette_C) == 0x000268, "Wrong size on ABP_SprayPalette_C");
...
static_assert(offsetof(ABP_SprayPalette_C, Plane) == 0x000250, "Member 'ABP_SprayPalette_C::Plane' has a wrong offset!");
static_assert(offsetof(ABP_SprayPalette_C, Scene) == 0x000258, "Member 'ABP_SprayPalette_C::Scene' has a wrong offset!");
static_assert(offsetof(ABP_SprayPalette_C, AkAudio) == 0x000260, "Member 'ABP_SprayPalette_C::AkAudio' has a wrong offset!");
