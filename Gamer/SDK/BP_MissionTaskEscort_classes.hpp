...
static_assert(sizeof(ABP_MissionTaskEscort_C) == 0x000680, "Wrong size on ABP_MissionTaskEscort_C");
static_assert(offsetof(ABP_MissionTaskEscort_C, Billboard) == 0x000678, "Member 'ABP_MissionTaskEscort_C::Billboard' has a wrong offset!");
