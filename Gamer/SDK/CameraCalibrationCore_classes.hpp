...
{
public:
	TMap<class FString, struct FVector>           SubPoints;                                         // 0x0518(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bVisualizePointsInEditor;                          // 0x0568(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_569[0x3];                                      // 0x0569(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PointVisualizationScale;                           // 0x056C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECalibrationPointVisualization                VisualizationShape;                                // 0x0570(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCalibrationPointComponent) == 0x000580, "Wrong size on UCalibrationPointComponent");
static_assert(offsetof(UCalibrationPointComponent, SubPoints) == 0x000518, "Member 'UCalibrationPointComponent::SubPoints' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, bVisualizePointsInEditor) == 0x000568, "Member 'UCalibrationPointComponent::bVisualizePointsInEditor' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, PointVisualizationScale) == 0x00056C, "Member 'UCalibrationPointComponent::PointVisualizationScale' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, VisualizationShape) == 0x000570, "Member 'UCalibrationPointComponent::VisualizationShape' has a wrong offset!");
